...
Upgrades from PGD 3.7 to PGD 5 are supported from version 3.7.20. There is no automated tooling for the upgrade currently but TPA will support the process in the future. For now, manual operations are required to complete the upgrade. Upgrade to 3.7.20 before upgrading to 5. See [Upgrading within version 3.7](/pgd/3.7/bdr/upgrades/supported_paths/#upgrading-within-version-37). After upgrading to 3.7.20 or later, the following combinations are allowed.
