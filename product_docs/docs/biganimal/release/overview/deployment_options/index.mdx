...
These two deployment options support certain BigAnimal features: 

| Feature | Supported on your own cloud account | Supported on BigAnimal's cloud account | Relevant topic |
| ------- | ----------------------------------- | -------------------------------------- | -------------- |
| Single node and high availability clusters | Yes | Yes | [Supported cluster types](/02_high_availibility) |
| Extreme-high-availability clusters | Yes | No | [Supported cluster types](/02_high_availibility) |
| Apache Superset | Yes | No | [Analyzing your data with Apache Super set](/biganimal/latest/using_cluster/06_analyze_with_superset/) |
| Superset access | Yes | No | [Managing Superset access](/biganimal/latest/administering_cluster/01a_superset_access/) |
